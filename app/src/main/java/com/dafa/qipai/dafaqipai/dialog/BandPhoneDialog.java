...
public abstract class BandPhoneDialog extends Dialog {
    ...
    public BandPhoneDialog(Activity context, String msg, String btnStr1, String btnStr2) {
    ...
    public BandPhoneDialog(Activity context, String msg) {
        super(context, R.style.MyDialog6);
        this.context = context;
        this.msg = msg;
        this.btnStr1 = btnStr1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn1DoThing(BandPhoneDialog.this);
            }
        });
                        ...
                        .execute(new OkGoCallBack(context, false) {
                            ...
                            protected void _onNext(String json) {
                                ...
                                if (doSessionInfo.getResult() == 1) {
                                    btn2DoThing(BandPhoneDialog.this);
