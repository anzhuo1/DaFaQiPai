...
public class SProgress extends View {
    ...
    private int maxDuring = 3600, minDuring = 500;
    ...
    private void startAnimator(float pors) {
        ...
        animator.setDuration(maxDuring);
    ...
    private String getText(float progress) {
        @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) String progresstext = String.format("", progress);
