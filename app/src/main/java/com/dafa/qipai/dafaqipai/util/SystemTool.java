...
public final class SystemTool {
    ...
    /**
     * 获取手机IMEI码  keytool -oiler_activty_status_record -keystore debug.keystore
     */
     ...
     * 调用系统打电话
     */
    public static void dialPhoneNumber(Context cxt, String phoneNumber) {
    ...
    public static boolean isSleeping(Context context) {
        ...
        if (kgMgr.inKeyguardRestrictedInputMode()) return true;
        else return false;
    }
