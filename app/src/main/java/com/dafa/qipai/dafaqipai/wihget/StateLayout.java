...
//            ImageView tv = (ImageView) progressView.findViewById(R.id.loadingIv);
//
//            tv.setBackgroundResource(R.drawable.frame_meituan);
//            // 通过ImageView对象拿到背景显示的AnimationDrawable
//            AnimationDrawable mAnimation = (AnimationDrawable) tv.getBackground();
//            // 为了防止在onCreate方法中只显示第一帧的解决方案之一
//            tv.post(() -> mAnimation.start());
